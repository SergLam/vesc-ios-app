...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral {
    ...
    self.statusLabel.text = self.isConnected ? @"CoreBluetooth BLE Connected" : @"CoreBluetooth BLE Not Connected";
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error {
    for (CBService *service in peripheral.services) {
        ...
        [self.statusLabel setText:@"Discovered VESC Services"];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(NSError *)error {
    ...
    if ([service.UUID isEqual:[CBUUID UUIDWithString:UART_SERVICE_UUID]])  {
        [self.statusLabel setText:@"Discovered UART Characteristics"];
        ...
        if (_txCharacteristic == nil && _rxCharacteristic == nil) {
            [self.statusLabel setText:@"RX and TX not discovered. Closing connection."];
