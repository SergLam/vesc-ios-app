...
@implementation VSCVescHelper

+ (VSCVescHelper *) sharedInstance {
    static VSCVescHelper *sharedInstance = nil;
...
- (int)processIncomingBytes:(NSData *)incomingData {
